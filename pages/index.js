...
export default function Home() {
  return (
     <div>
      {/*Metadados*/}
      <meta charSet="UTF-8" />
      <meta name="author" content="Desenvolvido por Hiago" />
      <meta
        name="description"
      ...
      {/*Titulo da Página*/}
      <title>Currículo Vitae | Hiago </title>
      {/*Conteiner da Pagina*/}
              ...
              <div className="w3-container w3-white text-grey w3-grid-4">
                ...
                <div className="w3-container">
                  ...
                  <div className="w3-light-grey w3-round-xlarge w3-small">
                    {/*Barrinha verde*/}
                    <div className="w3-container w3-center w3-round-xlarge w3-teal primeira-habilidade">
                      70%
                    </div>
                  </div>
                  {/*2º Habilidade*/}
            ...
            <div className="w3-content w3-card w3-white w3-margin-bottom">
              ...
              <div className="w3-container">
                <h5 className="w3-text-grey">
                  <b>Aluno Informática| Microcamp</b>
                </h5>
                <h6>
              ...
              <div className="w3-container">
                <h5 className="w3-text-grey">
                  <b>Tecnico de Administração| Proz</b>
                </h5>
                <h6>
                  <i className="fa fa-calendar fa-fw w3-text-teal" />
                  Out-2022
